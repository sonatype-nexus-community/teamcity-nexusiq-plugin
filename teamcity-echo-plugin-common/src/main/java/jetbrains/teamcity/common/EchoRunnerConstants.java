package jetbrains.teamcity.common;
...
public interface EchoRunnerConstants {
  ...
  String IQ_APPLICATIONID_KEY = "echoIQApplicationIdKey";
  String IQ_STAGE_KEY = "echoIQStageKey";
  String IQ_SCANTARGET_KEY = "echoIQScanTargetKey";
